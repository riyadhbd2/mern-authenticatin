...
const ResetPassword = ({url}) => {
  ...
  // function for sending input email and sending otp to reset password
  ...
  // function for input otp and compare otp to input otp and update state
  ...
  // function to input new password and set new password as password
    ...
    <div className="flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400">
      ...
      {!isEmailSent && (
        <form
          ...
          className="bg-slate-900 p-8 rounded-lg shadow-lg w96 text-sm"
        >
